...
#define CONFIGURE_ARGS " '--enable-debug' '--enable-cassert' '--prefix=/home/vlad/postgres_cluster/pgsql'"
...
#define PG_VERSION_STR "PostgreSQL 13.2 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.3.0-1ubuntu1~22.04.1) 11.3.0, 64-bit"

...
COPY COPY_TBL FROM '/home/vlad/postgres_cluster/build/../src/test/regress/data/constro.data';

SELECT '' AS two, * FROM COPY_TBL;

COPY COPY_TBL FROM '/home/vlad/postgres_cluster/build/../src/test/regress/data/constrf.data';
